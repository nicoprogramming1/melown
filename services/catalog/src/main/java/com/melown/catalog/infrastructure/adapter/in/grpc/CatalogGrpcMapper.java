...
public class CatalogGrpcMapper {
    ...
    public static GetProductResponse toResponseGet(GetProductResult result) {
        ...
        SpecificationsProto specifications = SpecificationsProto.newBuilder().putAllValues(result.getSpecifications().values()).build();

        ProductConditionProto productCondition = switch (result.getProductCondition()) {
            case NewCondition n -> ProductConditionProto.newBuilder()
                    .setNew(NewConditionProto.newBuilder()
                            .setGuarantee(n.guarantee())
                            .build())
                    .build();
            case UsedCondition u -> ProductConditionProto.newBuilder()
                    .setUsed(UsedConditionProto.newBuilder()
